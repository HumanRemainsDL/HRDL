...
| Evidence Type | The nature of material from which the record was collected | Type 1 | Either Textual or Archaeological [for launch records] |
| Reference Type | Narrative type of the record (not the whole document from which it was sourced) | Type 2 | One of the following: Passing Reference / Anecdote / Descriptive Account |
| Account Type | Type of publication of the original source | Type 3 | Subject Headings and genre/form terms for lib & archival materials by Library of Congress. Full list and definitions details provided on HRDL |
